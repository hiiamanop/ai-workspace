<script lang="ts">
	...
	const infrastructure = [
		...
		{ name: 'Workflow persistence', detail: 'Runs & state recovery', status: 'preview' as Status, metric: 'In setup', icon: Database, href: '/workspace/tools' },
		{ name: 'Audit pipeline', detail: 'Redacted event stream', status: 'ready' as Status, metric: 'Process-local', icon: EyeSlash, href: '/workspace/tools' }
	];
	const views = [
